...
svg.selectAll("rect")
	...
	.enter()
	.append("rect")
	.attr('x', function (d, i) { return i * (barchart_width / data.length) })
	.attr('y', function (d) { return barchart_height - d * 5; })
	.attr('width', barchart_width / data.length - bar_padding)
	.attr('height', function (d) { return d * 5; })
	.attr('fill', '#04c');  // blue bars
...
svg.selectAll('text')
	...
	.attr('y', function (d) { return barchart_height - d * 5 + 15; })
	.attr('font-size', 16)
	.attr('fill', 'white')
